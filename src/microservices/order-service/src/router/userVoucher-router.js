...
const uservoucherService = require("../service/userVoucher-service");
...
router.get("/", async (req, res) => {
  try {
    ...
    const result = await uservoucherService.getuserVoucher(
      search,
...
router.post("/", async (req, res) => {
  try {
    const result = await uservoucherService.createUserVoucher(req.body);
...
router.delete("/", async (req, res) => {
  try {
    var result = await uservoucherService.deleteVoucher(
      req.query.userId,
      req.query.voucherId
    );
    res.json(result);
