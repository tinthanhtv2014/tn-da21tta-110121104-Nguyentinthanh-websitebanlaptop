...
const connectMongoDB = require("./context/mongoDb");
    ...
    servers: [
      {
        url:
          process.env.NODE_ENV === "production"
            ...
            : `http://localhost:${process.env.SSO_PORT || 3001}`, // URL phát triển
      },
    ],
  },
  apis: ["./src/router/**/*.js"],
...
app.listen(PORT, () => {
  ...
  console.log("Tài liệu API có sẵn tại http://localhost:5005/api-docs");
});
